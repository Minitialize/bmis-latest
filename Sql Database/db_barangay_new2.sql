...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2024 at 06:51 AM
...
(13, 6, 'Juans Dela', 'Peter Lost anges Cayatano', '2023-11-06', '03:22:55', 'complaint1', 'testdesc1', 'testresponse', 'acknowledged', '2023-11-15T10:26', '2023-11-15T10:25', '', '');
...
(190, 149, 5, 176, 1, NULL, '', '0.000000', '', 2, '2023-11-06 10:22:32', '2023-11-06 10:22:34');
...
(116, 5, 23, '20', '2023-10-10 02:29:33', '2023-11-02 11:37:54', 'Process', ''),
...
(149, 6, 29, '1', '2023-11-06 10:22:32', '2023-11-06 10:22:32', 'Pending', ''),
(150, 6, 29, '2', '2024-01-30 19:46:11', '2024-01-30 19:46:11', 'Pending', ''),
(151, 6, 29, '2', '2024-01-30 19:46:12', '2024-01-30 19:46:12', 'Pending', ''),
(152, 6, 29, '2', '2024-01-30 19:49:17', '2024-01-30 19:49:17', 'Pending', ''),
(153, 6, 29, '3', '2024-01-30 19:49:43', '2024-01-30 19:49:43', 'Pending', '');
...
INSERT INTO `request_form_type` (`req_form_type_id`, `req_form_information_id`, `req_id`, `purpose`, `terms_of_living`, `cedula_number`, `date_deceased`, `place_of_death`, `father_name`, `mother_name`, `father_age`, `mother_age`, `animal_name`, `num_animal`, `sell_to`, `address_person`, `name_partner`, `bdate_partner`, `living_together`, `num_living_together`, `attached_photo`, `attached_file`, `created_at`, `updated_at`, `date_pickup`) VALUES
...
(176, 149, 5, 'test', '', '', 'null', '', '', '', '', '', '', 0, '', '', '', '', '', 0, '65484de8abb9d.jpg', '', '2023-11-06 10:22:32', '2023-11-06 10:22:32', '');
...
(12, 'Administrator', '2024-02-01 13:44:13', 'Added Zone number 001'),
(13, 'Administrator', '2024-02-01 13:45:04', 'Added Zone number 002');
...
CREATE TABLE `tblzone` (
  ...
  `zone_birthday` varchar(50) NOT NULL,
  `zone_address` varchar(50) NOT NULL,
  `bcontactno` varchar(50) NOT NULL,
  `position` varchar(50) NOT NULL,
  `emcontactno` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `tblzone` (`id`, `zone`, `username`, `password`, `zone_name`, `zone_birthday`, `zone_address`, `bcontactno`, `position`, `emcontactno`) VALUES
(1, '051820', 'zone_leader', 'zone_leader123', '', '', '', '', '', ''),
(5, '123123', 'zone_leader2', 'zone_leader2', '', '', '', '', '', ''),
(6, '123123123', 'zone_leader3', 'zone_leader3', '', '', '', '', '', ''),
(8, '001', 'test', 'test123', 'testfullname', '2000-02-10', 'testaddr ', '09123456789', 'testpos', '09123456789'),
(9, '002', 'test1', 'test123', 'testfullname', '1999-02-10', 'testaddr ', '09123456789', 'testpos', '09123456789');
...
--
ALTER TABLE `receipt_transaction`
  MODIFY `recep_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=191;

--
-- AUTO_INCREMENT for table `request_form_information`
--
ALTER TABLE `request_form_information`
  MODIFY `req_form_information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;

--
-- AUTO_INCREMENT for table `request_form_type`
--
ALTER TABLE `request_form_type`
  MODIFY `req_form_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
